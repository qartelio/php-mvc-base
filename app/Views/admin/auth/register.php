            ...
            <form class="mt-8 space-y-6" action="" method="POST">
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 transition duration-150 ease-in-out" placeholder="Введите ваше имя" required>
                    </div>
                ...
                <!-- Кнопка отправки -->
                <div>
                    <button type="submit" class="group relative flex w-full justify-center rounded-lg bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition duration-150 ease-in-out transform hover:scale-[1.02]">
                        Зарегистрироваться
                    </button>
                </div>
